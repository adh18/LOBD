...
if isfile('quantum_harmonic_oscillator_data_normalized.mat')
    load('quantum_harmonic_oscillator_timevarying_data.mat')
else
    run('quantum_harmonic_oscillator_timevarying_simulations')
end
...
% false (for not : TODO)
[lobd, output, z] = LOBD(sols, R, 'useminf', true, 'maxiters', 100000, 'cgiters', 5000, 'showevery', 10, 'tol', 1e-20, 'projectcoeffs', true);
...
save('quantum_harmonic_oscillator_timevarying_lobdresults.mat', 'tstart', 'R', 'lobd', 'usedsols', ...
